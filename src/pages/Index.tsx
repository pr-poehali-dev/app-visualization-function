...
const MODULES = [
  { id: 1, emoji: "💼", title: "Незаконное увольнение", tag: "Трудовое право", color: "from-green-500 to-emerald-700", content: "Уволить вас могут только по основаниям из ТК РФ. Если нарушен порядок — увольнение незаконно. Вы вправе обратиться в суд в течение 1 месяца и потребовать восстановления на работе и компенсации." },
  { id: 2, emoji: "💰", title: "Задержка зарплаты", tag: "Трудовое право", color: "from-emerald-500 to-teal-700", content: "Работодатель обязан платить зарплату дважды в месяц. При задержке свыше 15 дней вы вправе приостановить работу, письменно уведомив работодателя. За каждый день просрочки начисляется компенсация 1/150 ключевой ставки ЦБ." },
  { id: 3, emoji: "🛒", title: "Возврат товара", tag: "Права потребителя", color: "from-teal-500 to-green-700", content: "Качественный товар можно вернуть в течение 14 дней, если сохранён товарный вид. Некачественный — в течение гарантийного срока. Продавец обязан вернуть деньги или заменить товар в течение 10 дней." },
  { id: 4, emoji: "🔧", title: "Гарантийный ремонт", tag: "Права потребителя", color: "from-green-600 to-lime-700", content: "В период гарантии ремонт — за счёт продавца или производителя. Если ремонт затянулся дольше 45 дней — вы вправе требовать замены товара. Время ремонта продлевает гарантийный срок." },
  { id: 5, emoji: "🚗", title: "Права при остановке ГИБДД", tag: "ПДД и водители", color: "from-lime-600 to-green-700", content: "Инспектор обязан представиться и назвать причину остановки. Вы вправе снимать разговор на видео. Выходить из машины нужно только по законному требованию. Ключи и телефон отдавать не обязаны." },
  { id: 6, emoji: "📸", title: "Штраф с камеры", tag: "ПДД и водители", color: "from-emerald-600 to-green-800", content: "Штраф с камеры приходит собственнику авто. Если за рулём был другой — можно обжаловать, указав реального водителя. На обжалование — 10 дней с момента получения постановления. При оплате в 20 дней — скидка 50%." },
  { id: 7, emoji: "👨‍👩‍👧", title: "Алименты", tag: "Семейное право", color: "from-green-500 to-teal-700", content: "На одного ребёнка — 25% дохода, на двух — 33%, на троих и более — 50%. Можно договориться письменно у нотариуса или взыскать через суд. При уклонении — уголовная ответственность по ст. 157 УК РФ." },
  { id: 8, emoji: "🏠", title: "Выселение арендатора", tag: "Жильё и ЖКХ", color: "from-teal-600 to-emerald-800", content: "Хозяин не вправе выселить вас без суда, если есть договор аренды. Он обязан предупредить за 3 месяца при расторжении договора. Самовольное выселение и смена замков — незаконны, можно вызвать полицию." },
  { id: 9, emoji: "💡", title: "Долг за ЖКХ", tag: "Жильё и ЖКХ", color: "from-green-700 to-teal-900", content: "При долге более 2 месяцев могут отключить свет или воду (кроме отопления зимой). Выселить из муниципальной квартиры — только через суд при долге свыше 6 месяцев. Из собственной квартиры за долги ЖКХ не выселят." },
  { id: 10, emoji: "🔒", title: "Персональные данные", tag: "Цифровые права", color: "from-lime-500 to-green-700", content: "Вы вправе потребовать удалить свои данные из любой базы. Компании обязаны получить ваше согласие на обработку данных. За утечку персональных данных — штраф до 500 млн рублей для компании." },
  { id: 11, emoji: "🤝", title: "Расписка и долг", tag: "Гражданское право", color: "from-emerald-500 to-lime-700", content: "Расписка — доказательство долга в суде. Должна содержать: ФИО, сумму, дату возврата, подпись. Срок исковой давности по долгу — 3 года. При отказе платить — обращайтесь в суд за судебным приказом." },
  { id: 12, emoji: "👮", title: "Задержание полицией", tag: "Административное право", color: "from-green-600 to-emerald-800", content: "При задержании вы вправе: хранить молчание, потребовать адвоката, уведомить родственников. Максимальный срок без суда — 48 часов. Статья 51 Конституции: вы не обязаны свидетельствовать против себя." },
];
